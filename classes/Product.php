...
<?php 
 class Product {
  	...
  	public function productInsert($data,$file){
       ...
       $type=mysqli_real_escape_string($this->db->link,$data['type']);
        ...
        if ($productName == "" || $catId == "" || $brandId == "" || $body == "" || $price == "" || $file_name == "" || $type == "") {
         $msg="<span class='error'>Fields must not  to  be empty !</span>";
         return $msg;        
    ...
    public function insertWishData($id,$cmrId){
     ...
     if ($result) {
        ...
        $inserted_row=$this->db->insert($query);
         if ($inserted_row) {
            $msg="<span class='success'>Added ! Check to WishList Page!</span>";
            return $msg;  
        }else{
           $msg="<span class='error'>Not Added !</span>";
           return $msg;
    ...
    public function getWishProduct($cmrId){
      $query="SELECT * FROM tbl_wlist WHERE cmrId='$cmrId' ORDER BY id DESC";
      $result=$this->db->select($query);
      return $result;
    }
    public function delWishData($cmrId,$productId){
